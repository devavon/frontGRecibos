...
import axios from "axios"; // Aunque ya no lo usaremos directamente en handleLogin, lo dejamos por si lo usas en otro lado, pero es mejor eliminarlo si solo se usa en useAuth.
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Si no fue exitoso, el error ya está manejado en el contexto
        Swal.fire({
          icon: "error",
          title: "Error en el inicio de sesión",
          // Usamos el mensaje de error que nos devuelve el contexto
          text: result.message || "Credenciales incorrectas. Intente de nuevo.",
        });
      }
    } catch (error) {
